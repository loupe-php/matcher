...
class GermanBuilder extends AbstractKaikkiDictionaryBuilder
{
    private const DISALLOW_LIST = [
        ...
        'klass',
        'rege',
        'schreibe', // "die Schreibe (Art, Stil sich schriftlich auszudrücken)", pretty old stuff
        'sang', // short for "Gesang". It has the tag "outdated", maybe we could drop all of those?
    ];
